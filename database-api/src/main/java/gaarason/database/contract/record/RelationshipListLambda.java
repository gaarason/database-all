 ...
 * @author xt
 */
public interface RelationshipListLambda<T extends Serializable, K extends Serializable>
     ...
     */
    default RecordList<T, K> with(ColumnFunctionalInterface<T> fieldName,
                                  GenerateSqlPartFunctionalInterface<? extends Serializable, ? extends Serializable> builderClosure) {
