 ...
 * @author xt
 */
public interface JoinLambda<T extends Serializable, K extends Serializable> extends Join<T, K>, Support<T, K> {
     ...
     * @return 查询构造器
     */
    default Builder<T, K> join(String table, ColumnFunctionalInterface<T> column1, String symbol, ColumnFunctionalInterface<T> column2) {
