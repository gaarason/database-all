...
public class NullTestWIthFillModel extends SingleModel<NullTestWIthFillModel.Entity, Integer> {
    ...
    public static class Entity implements Serializable {
        ...
        @Column(length = 20, strategy = FieldStrategy.Always.class)
        private String name;

        @Column(name = "time_column", strategy = FieldStrategy.Always.class, fill = FieldFill.CreatedTimeFill.class)
        private LocalTime timeColumn;

        @Column(name = "date_column", strategy = FieldStrategy.Always.class, fill = FieldFill.UpdatedTimeFill.class)
