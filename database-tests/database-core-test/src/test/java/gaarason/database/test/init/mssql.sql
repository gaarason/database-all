...
set
IDENTITY_INSERT data_type on;

set
IDENTITY_INSERT data_type OFF;
...
set
IDENTITY_INSERT relationship_student_teacher ON
...
set
IDENTITY_INSERT relationship_student_teacher OFF;
