...
public interface RelationSubQuery {
     ...
     * @return 查询结果集
     */
    RecordList<? extends Serializable, ? extends Serializable> dealBatchPrepare(String sql1);
     ...
     * @return 筛选后的查询结果集
     */
    List<? extends Serializable> filterBatchRecord(Record<?, ?> theRecord, RecordList<?, ?> targetRecordList,
