...
import gaarason.database.test.parent.LocalDateTests;
import gaarason.database.test.parent.ORMTests;
...
public class MysqlLocalDateTests extends LocalDateTests {
